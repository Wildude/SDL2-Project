...
int main(int argn, char** args)
{
    ...
    while(event.type != SDL_QUIT)
    {
        ...
        Vint2* vert = new Vint2[sides];
        vert = n_gonr(center_v, sides, sidelength);
        for(int i = 0; i < sides; i++)vertices.push_back(vert[i]);
        //rotate_rC(vertices, angle2);
        //cout<<" here\n";
        ...
        if(in_polyB(vertices, mousepos, rayterm))
		{
        ...
        Vint2 center = C_x_y_find(vertices);
        cpoint.queryF();
