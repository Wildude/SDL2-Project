...
int main(int argn, char** argc){
    ...
    */
    ...
    while(!input.shouldQuit()){
        ...
        input.update();
        boxied.settext(std::string(theImage.getpath()) + " "  + std::to_string(theImage.getBox()->w) + ", " + std::to_string(theImage.getBox()->h));
